<?php
namespace Opencart\Admin\Model\Extension\Fraudlabspro\Fraud;
class Fraudlabspro extends \Opencart\System\Engine\Model {
	public function install(): void {
		...
		// $this->db->query("INSERT INTO `" . DB_PREFIX . "setting` (`code`, `key`, `value`, `serialized`) VALUES ('fraud_fraudlabspro', 'fraud_fraudlabspro_enable_ato', '1', '0');");
