...
$_['text_ip_distance']           = 'IP to Billing Distance';
$_['text_ip_latitude']           = 'IP Latitude';
$_['text_ip_longitude']          = 'IP Longitude';
$_['text_risk_country']          = 'High Risk Country';
$_['text_free_email']            = 'Free Email Domain';
$_['text_ship_forward']          = 'Ship Fordwarder';
$_['text_using_proxy']           = 'Proxy IP Address';
$_['text_ip_blacklist']          = 'IP in Blacklist';
$_['text_email_blacklist']       = 'Email in Blacklist';
...
$_['text_error']                 = 'Error:';
$_['text_flp_upgrade']           = '<a href="https://www.fraudlabspro.com/pricing" target="_blank">[Upgrade]</a>';
...
$_['entry_email_notification']   = 'Email Notification';
...
$_['help_email_notification']    = 'You can configure to receive email notification for the approve, review or reject action.';
$_['help_zapier_notification']   = 'You can trigger the notification, i.e, Slack notification, using the Zapier service.';
...
$_['help_ip_blacklist']          = 'Whether the IP address is in our blacklist database.';
$_['help_email_blacklist']       = 'Whether the email address is in our blacklist database.';
$_['help_phone_verify']          = 'Whether the phone number is verified by the customer.';
